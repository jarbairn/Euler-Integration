...
int main()
{
    ...
    ofstream outfile("euler-integration.csv");
    if (!outfile)
    {
        cerr << "error: unable to open euler-integration.csv" << endl;
    }

    std::cout << "Start Euler method " << std::endl;
// Note x<2 and i<100000 to stop iteration when x=2
// i<100000 adds a protection, if step is too small
    ...
    //Reset x and y before starting a new method
    y=-1.0;
    x=1.0;
    //reset
